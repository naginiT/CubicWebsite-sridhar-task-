...
WebDriver driver;
	...
	public void Exe() throws Exception{
	 ...
	 driver.get("http://cubicitsolution.co.in/project/mpower-admin/admin");
        ...
        /*File f=new File("C:\\Users\\sridhar\\Links\\Downloads\\Candidates_list.csv");
        System.out.println(f.getAbsolutePath());
		
		File f1=new File("E:\\mpower");
        FileUtils.moveFileToDirectory(f, f1, false);
		System.out.println("hiii");
		
		File f2=new File("E:\\mpower\\Candidates_list.csv");
		f2.delete();
		*/
			
			Thread.sleep(3000);
		File f=new File("C:\\Users\\sridhar\\Downloads\\Candidates_list.csv") ;
		System.out.println(f.getAbsolutePath());
